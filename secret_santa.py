...
players = [{'name': 'Paul', 'email': 'pnichols104@gmail.com', 'elf': '', 'exclude': ['Jason']},
           {'name': 'Jason', 'email': 'jason.b.olsen@gmail.com',
               'elf': '', 'exclude': ['Paul']},
           {'name': 'Matt', 'email': 'matthew.angrisani@gmail.com',
               'elf': '', 'exclude': ['Emily']},
           {'name': 'Emily', 'email': 'emily.angrisani@gmail.com',
               'elf': '', 'exclude': ['Matt']},
           {'name': 'Barbara', 'email': 'bknispel@mindspring.com',
               'elf': '', 'exclude': ['David']},
           {'name': 'David', 'email': ' dkennedy18@nyc.rr.com',
               'elf': '', 'exclude': [' Barbara']},
           {'name': 'Sandy', 'email': 'sangrisani@hotmail.com',
               'elf': '', 'exclude': ['']},
           ]
